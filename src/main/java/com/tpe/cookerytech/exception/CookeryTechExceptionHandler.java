...
import com.tpe.cookerytech.exception.message.ApiResponseError;
...
@ControllerAdvice
public class CookeryTechExceptionHandler extends ResponseEntityExceptionHandler {


    private ResponseEntity<Object> builtResponseEntity(ApiResponseError error){
    ...
    protected ResponseEntity<Object> handleResourceNotFoundException(
        ...
        return builtResponseEntity(error);
    }
